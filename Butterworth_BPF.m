...
plot(f,abs(H))
%line([0;5e4],[0.85;0.85],'Color', 'green','linestyle','--');
line([34.5e3;34.5e3],[0;1.2],'Color', 'black');
line([30.5e3;30.5e3],[0;1.2],'Color', 'black');
line([54.5e3;54.5e3],[0;1.2],'Color', 'black');
line([58.5e3;58.5e3],[0;1.2],'Color', 'black');
%line([0;5e4],[0.85;0.85],'Color', 'black');
%line([0;5e4],[0.15;0.15],'Color', 'black');
xlabel('Frequency(Hz)');
ylabel('|H(f)|');
grid